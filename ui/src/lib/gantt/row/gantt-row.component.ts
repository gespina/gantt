...
import { SeyGanttEventComponent } from '../event/gantt-event.component';
import { EventType } from '../interfaces/event.type';

@Component({
  selector: 'sey-gantt-row',
  standalone: true,
  imports: [CommonModule, SeyGanttEventComponent],
  templateUrl: './gantt-row.component.html',
  styleUrls: ['./gantt-row.component.scss'],
})
export class SeyGanttRowComponent<T extends EventType> implements OnInit{
  /**
   * Row data
   */
  @Input()
